                    ...
                    >
                        ...
                        <JVCheckboxGroup size="large" title="Show tabs">
                            <JVCheckbox label="Schedule"
                                        CheckboxProps={{
                                            checked: showTabs.schedule,
                                            name: "schedule",
                                            onChange: handleShowTabChange
                                        }}/>
                            <JVCheckbox label="Parameters"
                                        CheckboxProps={{
                                            checked: showTabs.parameters,
                                            name: "parameters",
                                            onChange: handleShowTabChange
                                        }}/>
                            <JVCheckbox label="Notifications"
                                        CheckboxProps={{
                                            checked: showTabs.notifications,
                                            name: "notifications",
                                            onChange: handleShowTabChange
                                        }}/>
                            <JVCheckbox label="Output"
                                        CheckboxProps={{
                                            checked: showTabs.output,
                                            name: "output",
                                            onChange: handleShowTabChange
                                        }}/>
                        ...
                        {showTabs.schedule && (<JVCheckboxGroup size="large" title="Show schedules fields">
                            <JVCheckbox label="label"
                                        CheckboxProps={{
                                            checked: showScheduleFields.label,
                                            name: "label",
                                            onChange: handleShowScheduleFieldsChange
                                        }}/>
                            <JVCheckbox label="description"
                                        CheckboxProps={{
                                            checked: showScheduleFields.description,
                                            name: "description",
                                            onChange: handleShowScheduleFieldsChange
                                        }}/>
                            <JVCheckbox label="recurrenceInterval"
                                        CheckboxProps={{
                                            checked: showScheduleFields.recurrenceInterval,
                                            name: "recurrenceInterval",
                                            onChange: handleShowScheduleFieldsChange
                                        }}/>
                            <JVCheckbox label="recurrenceIntervalUnit"
                                        CheckboxProps={{
                                            checked: showScheduleFields.recurrenceIntervalUnit,
                                            name: "recurrenceIntervalUnit",
                                            onChange: handleShowScheduleFieldsChange
                                        }}/>
                            <JVCheckbox label="startTime"
                                        CheckboxProps={{
                                            checked: showScheduleFields.startTime,
                                            name: "startTime",
                                            onChange: handleShowScheduleFieldsChange
                                        }}/>
                        </JVCheckboxGroup>)}
                        ...
                        {showTabs.notifications && (<JVCheckboxGroup size="large" title="Show notifications fields">
                            <JVCheckbox label="address"
                                        CheckboxProps={{
                                            checked: showNotificationsFields.address,
                                            name: "address",
                                            onChange: handleShowNotificationsFieldsChange
                                        }}/>
                            <JVCheckbox label="subject"
                                        CheckboxProps={{
                                            checked: showNotificationsFields.subject,
                                            name: "subject",
                                            onChange: handleShowNotificationsFieldsChange
                                        }}/>
                            <JVCheckbox label="messageText"
                                        CheckboxProps={{
                                            checked: showNotificationsFields.messageText,
                                            name: "messageText",
                                            onChange: handleShowNotificationsFieldsChange
                                        }}/>
                            <JVCheckbox label="resultSendType"
                                        CheckboxProps={{
                                            checked: showNotificationsFields.resultSendType,
                                            name: "resultSendType",
                                            onChange: handleShowNotificationsFieldsChange
                                        }}/>
                        ...
                        {showTabs.output && (<JVCheckboxGroup size="large" title="Show output fields">
                            <JVCheckbox label="baseOutputFilename"
                                        CheckboxProps={{
                                            checked: showOutputFields.baseOutputFilename,
                                            name: "baseOutputFilename",
                                            onChange: handleShowOutputFieldsChange
                                        }}/>
                            <JVCheckbox label="outputDescription"
                                        CheckboxProps={{
                                            checked: showOutputFields.outputDescription,
                                            name: "outputDescription",
                                            onChange: handleShowOutputFieldsChange
                                        }}/>
                            <JVCheckbox label="outputFormat"
                                        CheckboxProps={{
                                            checked: showOutputFields.outputFormat,
                                            name: "outputFormat",
                                            onChange: handleShowOutputFieldsChange
                                        }}/>
                            <JVCheckbox label="outputTimeZone"
                                        CheckboxProps={{
                                            checked: showOutputFields.outputTimeZone,
                                            name: "outputTimeZone",
                                            onChange: handleShowOutputFieldsChange
                                        }}/>
